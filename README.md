...
- 玩法:WASD 移动、鼠标瞄准(默认自动出剑)、右键 / K 重击、空格踏云步、E 灵光爆、Q 换法宝、F 炼器坊 / 布下法阵、Tab 自动 / 手动、Esc 暂停;五山、五件法宝、27 门功法、四只精英、八分钟刑天、十分钟过山后问道无尽;四档难度(清修 / 修行 / 劫难 / 常羊)、功法学满后的三门神通;中途退出可从标题页续上局;支持触屏与手柄,中 / 英文切换
